...
<body class="background">
    ...
    <div class="container rounded center text-center bg-white border font-weight-bold mt-5 mb-5">
        ...
        <div class="row">
            <div class="col-12">
                <input type="text" class="form-control input-field max-width-500px center" id="magassag">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <input type="text" class="form-control input-field max-width-500px center" id="testsuly">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <input type="text" class="form-control input-field max-width-500px center" id="eletkor">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <p class="font-weight-normal">2000 kcal</p>
            </div>
        </div>
